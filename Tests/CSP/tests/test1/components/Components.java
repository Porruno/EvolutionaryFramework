...
public class Components {
    ...
    public static Variable kappa(CSP csp){
        int i;        
        ...
        String variableId = VariableOrderingHeuristics.selectNextVariable(variables, evaluations, VariableOrderingHeuristics.LARGEST);
        return csp.getVariable(variableId);
    }

    public static VariablesValues1 conflicts(CSP csp) {
        Variable variables[] = csp.getUninstantiatedVariables();
    ...
    public static VariablesValues1 constraintsInvolved(CSP csp) {
        Variable variables[] = csp.getUninstantiatedVariables();
    ...
    public static VariablesValues1 fdeg(CSP csp) {
        Variable variables[] = csp.getUninstantiatedVariables();
    ...
    public static VariablesValues1 bdeg(CSP csp) {
        Variable variables[] = csp.getUninstantiatedVariables();
    ...
    public static VariablesValues1 bbz(CSP csp) {
        Variable variables[] = csp.getUninstantiatedVariables();
    ...
    public static VariablesValues1 fbz(CSP csp) {
        Variable variables[] = csp.getUninstantiatedVariables();
    ...
    public static VariablesValues1 mxi(CSP csp) {
        Variable variables[] = csp.getUninstantiatedVariables();
    ...
    public static VariablesValues2 pxi(CSP csp) {
        Variable[] variables = csp.getUninstantiatedVariables();
    ...
    public static VariableValue smallest(VariablesValues1 arg0, CSP csp) {
        ...
        Variable largestVariable = csp.getUninstantiatedVariables()[largestValuePosition];
        return new VariableValue(largestVariable, largestValue);
    }

    public static VariableValue largest(VariablesValues1 arg0, CSP csp) {
        double largestValue = arg0.values[0];
        int largestValuePosition = 0;
        for (int i = 1; i < arg0.values.length; i++) {
            if (arg0.values[i] > largestValue) {
